...
document.addEventListener('DOMContentLoaded', function () {
    // ScrollSpy substitute (NOTE: Bootstrap scrollspy requires Bootstrap's JS or custom logic)
    document.querySelector('.body')?.classList.add("ct-render");

    // Mouseenter/mouseleave hover effect
    document.querySelectorAll('.nav-item').forEach(navItem => {
        ['mouseenter', 'mouseleave'].forEach(evt => {
            navItem.addEventListener(evt, function (e) {
    ...
    // Scroll event to trigger calcer
    window.addEventListener('scroll', calcer);
});
    calcer();
